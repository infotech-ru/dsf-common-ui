...
export function searchIcon() {
      ...
      const itemsObject = {
        ...
        'bicolors-circle_check': ['круг', 'circle', 'проверка', 'ok', 'check', 'minvb'],
        'bicolors-circle_check__24vb': ['круг', 'circle', 'проверка', 'ok', 'check', '24vb'],
        ...
        'bicolors-square_empty_check': ['квадрат', 'square', 'пустой', 'empty', 'проверка', 'ok', 'check', 'minvb'],
        'bicolors-square_empty_check__24vb': ['квадрат', 'square', 'пустой', 'empty', 'проверка', 'ok', 'check', '24vb'],
