...
export function searchIcon() {
      ...
      const itemsObject = {
        ...
        'bicolors-arrow_check': ['arrow', 'стрелка', 'проверка', 'check', 'minvb'],
        ...
        'bicolors-arrow_left': ['arrow', 'стрелка', 'left', 'лево', 'влево', 'minvb'],
        ...
        'bicolors-arrows_compare': ['arrows', 'сравнить', 'compare', 'minvb'],
        ...
        'bicolors-arrows_reload': ['arrows', 'перезагрузка', 'перезагрузить', 'reload', 'minvb'],
        ...
        'bicolors-book': ['книга', 'book', 'minvb'],
        'bicolors-book__24vb': ['книга', 'book', '24vb'],
        'bicolors-book_lamp': ['книга', 'book', 'лампа', 'lamp', 'minvb'],
        ...
        'bicolors-call': ['звонок', 'call', 'minvb'],
        'bicolors-call__24vb': ['звонок', 'call', '24vb'],
        'bicolors-call_back': ['звонок', 'call', 'назад', 'обратно', 'back', 'minvb'],
        'bicolors-call_back__24vb': ['звонок', 'call', 'назад', 'обратно', 'back', '24vb'],
        'bicolors-call_cold': ['звонок', 'call', 'холодный', 'cold', 'minvb'],
        'bicolors-call_cold__24vb': ['звонок', 'call', 'холодный', 'cold', '24vb'],
        'bicolors-call_import': ['звонок', 'call', 'импорт', 'import', 'minvb'],
        ...
        'bicolors-car_check': ['авто', 'машина','vehicle', 'car', 'проверка', 'check', 'minvb'],
        ...
        'bicolors-car_square_check': ['авто', 'машина','vehicle', 'car', 'квадрат', 'square', 'проверка', 'check', 'minvb'],
        ...
        'bicolors-cart_check': ['корзина', 'покупка', 'cart', 'проверка', 'check', 'minvb'],
        ...
        'bicolors-circle_check': ['круг', 'circle', 'проверка', 'check', 'minvb'],
        'bicolors-circle_check__24vb': ['круг', 'circle', 'проверка', 'check', '24vb'],
        'bicolors-circle_ignore': ['круг', 'circle', 'игнорировать', 'ignore', 'minvb'],
        ...
        'bicolors-doc_excel': ['doc', 'документ', 'эксель', 'excel', 'minvb'],
        ...
        'bicolors-export': ['экспорт', 'export', 'minvb'],
        ...
        'bicolors-import': ['импорт', 'import', 'minvb'],
        ...
        'bicolors-leasing': ['лизинг', 'leasing', 'minvb'],
        ...
        'bicolors-list_checked': ['список', 'list', 'проверено', 'checked', 'minvb'],
        'bicolors-list_checked__24vb': ['список', 'list', 'проверено', 'checked', '24vb'],
        ...
        'bicolors-notification': ['уведомление', 'сообщение', 'notification', 'minvb'],
        ...
        'bicolors-questions': ['questions', 'вопрос', 'minvb'],
        'bicolors-questions__24vb': ['questions', 'вопрос', '24vb'],
        'bicolors-questions_full': ['questions', 'вопрос', 'полный', 'заполненый', 'full', 'minvb'],
        ...
        'bicolors-send': ['send', 'отправить', 'minvb'],
        ...
        'bicolors-shield': ['щит', 'защита', 'безопасность', 'shield', 'minvb'],
        ...
        'bicolors-sms_check': ['смс', 'сообщение', 'sms', 'проверка', 'check', 'minvb'],
        ...
        'bicolors-square_empty': ['квадрат', 'square', 'пустой', 'empty', 'minvb'],
        'bicolors-square_empty__24vb': ['квадрат', 'square', 'пустой', 'empty', '24vb'],
        'bicolors-square_empty_check': ['квадрат', 'square', 'пустой', 'empty', 'проверка', 'check', 'minvb'],
        ...
        'bicolors-telegram': ['telegram', 'телега', 'minvb'],
        ...
        'bicolors-time': ['время', 'часы', 'time', 'minvb'],
        'bicolors-time__24vb': ['время', 'часы', 'time', '24vb'],
        'bicolors-time_wait': ['время', 'часы', 'time', 'wait', 'minvb'],
        'bicolors-time_wait__24vb': ['время', 'часы', 'time', 'wait', '24vb'],
        'bicolors-timeback': ['обратно', 'обратный', 'время', 'назад', 'timeback', 'minvb'],
        ...
        'bicolors-user_check': ['пользователь', 'user', 'проверка', 'check', 'minvb'],
