var DSFUI = (function (exports) {
    ...
    function searchIcon() {
      ...
      var itemsObject = {
        ...
        'bicolors-favorite': ['любимый', 'favorite', 'закладка', 'minvb'],
        'bicolors-favorite__24vb': ['любимый', 'favorite', 'закладка', '24vb'],
        'bicolors-favorite_check': ['любимый', 'favorite', 'закладка', 'minvb'],
        'bicolors-favorite_check__24vb': ['любимый', 'favorite', 'закладка', '24vb'],
        'bicolors-favorite_plus': ['любимый', 'favorite', 'закладка', 'minvb'],
        'bicolors-favorite_plus__24vb': ['любимый', 'favorite', 'закладка', '24vb'],
        'bicolors-favorite_full': ['любимый', 'favorite', 'полный', 'заполненый', 'закладка', 'full', 'minvb'],
        'bicolors-favorite_full__24vb': ['любимый', 'favorite', 'полный', 'заполненый', 'закладка', 'full', '24vb'],
